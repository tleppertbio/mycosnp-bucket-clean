...
### Running mycosnp-bucket-clean.py
  ...
  **What does this do?**
  ...
  This program uses to determine if a run has completed successfully or possibly needs re-queuing or has failed.
  If any queued SRR completed to .maple, .g.vcf.gz, .done and .finished, then the run has completed.
